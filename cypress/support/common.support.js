...
import { generateAddtoCartCardSelector } from './common/utils.js'
...
export function fillInformation() {
  cy.get('#client-first-name').type('saravanan')
  cy.get('#client-last-name').type('reddy')
  cy.get('#client-phone').type('(778) 822 3311', {
    delay: 50,
  })
